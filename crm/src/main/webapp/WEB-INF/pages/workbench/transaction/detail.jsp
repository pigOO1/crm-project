...
<%--
	...
	<div style="position: relative; top: 100px; left: 40px;">
		...
		<c:forEach var="tranRemark" items="${tranRemarkList}">
			<div class="remarkDiv" style="height: 60px;" id="div_${tranRemark.id}">
				<img title="tranRemark.noteContent" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>哎呦！</h5>
					<font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${tranRemark.editFlag == "1" ? tranRemark.editTime : tranRemark.createTime} 由${tranRemark.editFlag == "1" ? tranRemark.editBy : tranRemark.createBy}${tranRemark.editFlag == "1" ? '修改' : '创建 '}</small>
					<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
						<a class="myHref" id="${tranRemark.id}" name="editA" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #E6E6E6;"></span></a>
						&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="myHref" id="${tranRemark.id}" name="deleteA" href="javascript:void(0);"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #E6E6E6;"></span></a>
					</div>
				</div>
			</div>
		</c:forEach>
